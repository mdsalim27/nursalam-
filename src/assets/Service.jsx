            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="space-y-16 py-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 items-center">
                        <div>
                            <h3 className="text-2xl font-bold mb-4">Paper Bag</h3>
                            <p className="text-gray-600 leading-relaxed mb-2">
                                Our premium paper bags combine durability with elegant style.
                            </p>
                            <ul className="list-disc list-inside text-gray-600 space-y-1">
                                <li>High-quality materials with custom printing</li>
                                <li>Strengthen your brand image</li>
                                <li>Perfect for retail stores, boutiques, and corporate packaging</li>
                            </ul>
                        </div>
                        <div>
                            <img
