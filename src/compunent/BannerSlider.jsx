...
export default function BannerSlider() {
    ...
    return (
        <div className="w-full -mb-[80px] min-h-[60vh] md:min-h-[80vh] lg:min-h-screen relative overflow-hidden">            {slides.map((slide, index) => (
            <div
                key={slide.id}
            ...
            >
                <img
                    src={slide.img}
                    alt=""
                    className="w-full lg:pt-30 h-full object-contain"
                />
            </div>
        ))}
