...
export default function BannerSlider() {
  ...
  return (
    <section className="h-80 w-screen overflow-hidden relative">
      <div className="relative w-full h-full">
        ...
        {slides.map((slide, index) => {
          ...
          return (
            <div
              key={slide.id}
              className={`absolute inset-0 transform transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform ${position}`}
            >
              <img
                src={slide.img}
                alt=""
